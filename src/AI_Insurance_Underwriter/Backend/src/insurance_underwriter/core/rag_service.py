...
class PolicyRAGService:
    ...
    def __init__(
        ...
        # ✅ FIX: Use CHROMA_DB_PATH from config.py instead of calculating manually
        if db_path is None:
        ...
        _ = self.embeddings.embed_query("test initialization")
        ...
        try:
            ...
            print(f"✅ Found collection '{self.collection_name}' with {self.collection.count()} documents")
