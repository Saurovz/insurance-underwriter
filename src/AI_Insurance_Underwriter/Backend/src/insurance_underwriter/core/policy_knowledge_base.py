...
if __name__ == "__main__":
    ...
    # POLICY_PDF_PATH = "D:/Ai_POC/development/usecases.ai/src/AI_Insurance_Underwriter/Backend/src/insurance_underwriter/Policy_Doc/Health Insurance Policy Rules & Regulations 2.pdf"
    from pathlib import Path
    
    # This script is at: insurance_underwriter/core/policy_knowledge_base.py
    # Policy_Doc is at: insurance_underwriter/Policy_Doc/
    current_dir = Path(__file__).parent.parent  # Go to insurance_underwriter/
    POLICY_PDF_PATH = current_dir / "Policy_Doc" / "Health Insurance Policy Rules & Regulations 2.pdf"
